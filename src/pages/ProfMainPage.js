...
import ProfCalendar from "../components/ProfComponents/ProfCalendar";
    ...
    return(
        <div className="inAppBody">
            <nav className="sidebar">
                ...
                <ul>
                    <li>
                        <button onClick={()=>showProfComponent('home')} >
                    ...
                    <li>
                        ...
                        <svg width="22" height="21" viewBox="0 0 32 32"><path fill="currentColor" d="M12 4a5 5 0 1 1-5 5a5 5 0 0 1 5-5m0-2a7 7 0 1 0 7 7a7 7 0 0 0-7-7zm10 28h-2v-5a5 5 0 0 0-5-5H9a5 5 0 0 0-5 5v5H2v-5a7 7 0 0 1 7-7h6a7 7 0 0 1 7 7zm0-26h10v2H22zm0 5h10v2H22zm0 5h7v2h-7z"/></svg>
                        <p>Το προφίλ μου</p>
                        </button>
                    </li>  
                    <li>
                ...
                {/* <SearchBar/> *
                    <div class="icons">
                        <button onClick={()=>showProfComponent('home')} id='headerIcon'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="#004d60" d="M19 21H5a1 1 0 0 1-1-1v-9H1l10.327-9.388a1 1 0 0 1 1.346 0L23 11h-3v9a1 1 0 0 1-1 1zM6 19h12V9.157l-6-5.454l-6 5.454V19z"/></svg>
                        </button> 
