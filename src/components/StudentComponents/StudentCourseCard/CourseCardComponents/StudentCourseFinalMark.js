...
function StudentCourseFinalMark(){
    ...
    const [editMark,setEditMark] = useState("noEdit");
    ...
    return(
        <div class="studentFinalMark">
            <div class="predictionHeaderSmall">
                    <div class="predictionTitleBoxSmall">
                        <span>Τελικός βαθμός</span>
                    </div>    
            </div>

            <div class="insertFinalMark">
             { editMark === "noEdit" ?
               <>
                <label>Βαθμός</label>
