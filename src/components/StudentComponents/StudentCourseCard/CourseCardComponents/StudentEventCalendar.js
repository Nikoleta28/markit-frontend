...
// function StudentEventCalendar(props){
...
//     fetch(`http://localhost:8080/mark-it/student/${studentId}/course/${courseId}/studyHoursList/editStudyHours`, {
//         method: 'PUT',
//         headers: {
...
//           {title!=null && editEvent==false &&
//             <div className="clendarEvent" >
//               <label>{title}</label>
    
//              <>
//               <button id="calBtn" onClick={(e) => handleEditClick()} >
...
//           { editEvent==true &&
//             <form className="clendarEvent" onSubmit={e => updateEvent(e)} >
...
//               </button>
//               <button onClick={setEditEvent(false)}>
